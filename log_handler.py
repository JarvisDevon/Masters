...
def calc_all_means(logs, train_names):
  ...
  for name in train_names:
      ...
      wandb.log({"final_"+name+"_train_mean": new_set[0][-1], "final_"+name+"_test_mean": new_set[1][-1],\
             name+"_time_mean": new_set[2]})
...
def calc_all_std(logs, train_names):
  ...
  for name in train_names:
      ...
      wandb.log({"final_"+name+"_train_std": new_set[0][-1], "final_"+name+"_test_std": new_set[1][-1],\
             name+"_time_std": new_set[2]})
      log_sets.append(new_set)
  return log_sets
